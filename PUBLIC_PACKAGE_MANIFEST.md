...
`cold-read/**` is the editor itself: `identity.md`, `rules.md`, `examples.md`, `reference/architecture-judgments.md`, `reference/findings-and-labels.md`, and `README.md`. With that folder expanded, the release is **15 files** in total.
